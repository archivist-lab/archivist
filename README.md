...
## 🏛️ The Philosophy: The Digital Museum
...
*   **🛠️ Restoration (Conservation Lab):** Automated FFmpeg track cleaning and metadata refinement.
*   **🗄️ Vault (Archives):** Atomic hardlinking and structured storage for long-term preservation.
*   **🖼️ Galleries (Exhibition):** A stunning, cyberpunk-inspired UI for browsing your collection.

## ✨ Key Features

*   **🍿 Multi-Media Support:** Dedicated workflows for 🎬 Films, 📺 Series, 🎵 Music, 📚 Books, 💬 Comics, and 🎮 Games.
*   **⚙️ Embedded Torrent Engine:** Powered by `@torrentstack` - no external clients required.
...
*   **🗃️ Database:** SQLite (WAL Mode) with Better-SQLite3
*   **🎞️ Media Processing:** FFmpeg and ffprobe
*   **🛡️ Validation:** Zod (Type-safe schema validation)
...
archivist/
 ...
 │   ├── modules/     # 🏛️ Domain-specific logic (Acquisitions, Vault, etc.)
 │   ├── services/    # 🛠️ Core system services (Torrent, Media Processor)
 │   └── server.ts    # 🚀 Application entry point
 ├── data/            # 🗃️ SQLite DBs, Torrents, and App state
...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/archivist-lab/archivist.git](https://github.com/archivist-lab/archivist.git)
    cd archivist
    ```
...
5.  **🗄️ Archive:** The Vault hardlinks the cleaned file into your library.
6.  **🖼️ Display:** The item appears in the Galleries, ready for viewing.
