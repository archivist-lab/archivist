import type { ArtistRatingTree, RatingSubjectType, ResolvedRating, SeriesRatingTree, UnratedQueueItem } from '@archivist/contracts'
...
export const ratingsApi = {
  ...
  artistTree: (artistId: number) => request<ArtistRatingTree>(`/ratings/artist/${artistId}/tree?profile=${encodeURIComponent(profile)}`),
